...
Use this checklist before creating the `v1.0.1` manuscript release.

## Repository

- [ ] Confirm `reflectogen.py --version` reports `ReflectoGen 1.0.1`.
...
git status
git add .
git commit -m "Prepare ReflectoGen v1.0.1 manuscript release"
git tag -a v1.0.1 -m "ReflectoGen v1.0.1"
git push origin main
git push origin v1.0.1
```

Then create a GitHub release from the `v1.0.1` tag.

## Zenodo archive

- [ ] Enable Zenodo archiving for the GitHub repository.
- [ ] Archive the GitHub `v1.0.1` release.
